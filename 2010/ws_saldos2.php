...
include_once("./nu-soap/lib/nusoap.php");
...
function infoEmpleado($curp,$noControl) {		######### Metodo para obtener los datos del empleado
	$iConn = odbc_connect("DSN=pensiones;UID=;;SourceDB=c:\bases\base;SourceType=DBF","","");	#Realizo Conexion
...
function adeudo($curp, $noControl) {
	$iConn = odbc_connect("DSN=pensiones;UID=;;SourceDB=c:\bases\base;SourceType=DBF","","");
...
die(var_dump(adeudoHip(17288,334874)));
...
function entidades($clave) {		#Metodo para obtener un Listado de las entidades
	$iConn = odbc_connect("DSN=pensiones;UID=;;SourceDB=c:\bases\base;SourceType=DBF","","") or die(odbc_errormsg() );;
