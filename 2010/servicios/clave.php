					  ...
					  <table align="center" width="80%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
                        <tr>
                                  ...
                                  <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                    ...
                                    <tr>
                                      ...
                                      <td width="62%" class="textoPies"><div align="left">
                                        <input name="sClave" type="password" id="sClave" maxlength="18">
                                      </div></td>
                                    </tr>
                                    <tr>
                                      <td class="textoPies"><div align="right">Confirmar Clave: </div></td>
                                      <td class="textoPies"><div align="left">
                                        <input name="sClave2" type="password" id="sClave2" maxlength="18">
                                      </div></td>
                                    </tr>
                                    <tr>
                                      <td class="textoPies">&nbsp;</td>
                          ...
                          <?
                            ...
                            if (isset($_POST['sClave']) && removeXss($_POST['sClave'])==0 && strlen($_POST['sClave'])>=6 && strlen($_POST['sClave'])<=18) {
                                $sClave1=$_POST['sClave'];
                                #echo $_POST['sClave2'];
                                if (isset($_POST['sClave2']) && removeXss($_POST['sClave2'])==0 && strlen($_POST['sClave2'])>=6 && strlen($_POST['sClave2'])<=18) {
                                ...
                                if ($iError==0) {	#Valida que es correcta la informacion
                                    ...
                                    $client = new nusoap_client('http://dirpensiones.no-ip.org/nusoap/ws_saldos.php?wsdl', true);	#Server
