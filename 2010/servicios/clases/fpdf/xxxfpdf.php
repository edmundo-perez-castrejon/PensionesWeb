...
function FPDF($orientation='P', $unit='mm', $format='A4')
{
	...
	$this->PageFormats=array('a3'=>array(841.89,1190.55), 'a4'=>array(595.28,841.89), 'a5'=>array(420.94,595.28),
		'letter'=>array(612,792), 'legal'=>array(612,1008),'sefome'=>array(249,334),'ticket'=>array(218,454));
	if(is_string($format))
...
function Header()
{
	$logo=$_SERVER['DOCUMENT_ROOT'].'/webcol/imagenes/img/logo_colimalate.jpg';
...
function Footer()
{
	//To be implemented in your own inherited class
	   ...
	   $this->Image('http://10.10.20.20/webcol/imagenes/img//pie-hoja-carta.jpg',10,259,195,15);
