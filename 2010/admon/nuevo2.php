...
if($IIdUser=="" || $IIdDep==""){
	...
	//echo $ConBD1;
	//echo $ValNum." ".$ValDep." ".$Cla1." ".$Cla2." ".$Usu;
	...
	//echo $ConnS;
	/*if($ConnS!=0){
		$msg="El%20nombre%20de%20usuario%20ya%20existe,%20Favor%20de%20Cambiarlo";
		header("Location: nuevo.php?num=$ValNum&dep=$ValDep&msg=$msg");
	}else{*/
                  ...
                  <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><!-- InstanceBeginEditable name="info" -->
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><div align="center"><a href="nuevo.php">Nuevo</a></div></td>
                            <td><div align="center"><a href="cerrar_sesion.php">Cerrar Sesion</a> </div></td>
                          </tr>
                        </table>
						<p>&nbsp;</p>
                        <p align="center">&nbsp;</p>
                        <p align="center" class="tituloPeq">
						<?
						...
						$sql = "UPDATE internet SET clave='$Cla1' WHERE ficha = '$ValNum' AND entidad = $ValDep";
						...
						if($num>0){
							echo "SE GUARDARON CORRECTAMENTE LOS CAMBIOS";
						}else{
