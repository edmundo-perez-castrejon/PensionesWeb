...
// necessary classes
require_once('../../clases/lib/class.soapclient.php');
require_once('../../clases/lib/class.soap_val.php');
require_once('../../clases/lib/class.soap_parser.php');
require_once('../../clases/lib/class.soap_fault.php');

// transport classes
require_once('../../clases/lib/class.soap_transport_http.php');

// optional add-on classes
require_once('../../clases/lib/class.xmlschema.php');
require_once('../../clases/lib/class.wsdl.php');

// server class
require_once('../../clases/lib/class.soap_server.php');*/
