      ...
      <div id="container">
		...
		<!--Navegacion vertical-->      
          ...
          <div id="contenido_interior_icc">
          			<div id="ruta_sitio"><a href="http://pensiones.col.gob.mx/2010/index.php"><strong>inicio</strong></a>  &nbsp;&nbsp;&nbsp; •  &nbsp; <!-- InstanceBeginEditable name="seccion" --><a href="#">Requisitos para pr&eacute;stamo a corto plazo</a><!-- InstanceEndEditable -->   &nbsp;&nbsp;•    &nbsp;&nbsp;<!-- InstanceBeginEditable name="contenido" --><a href="#"></a><!-- InstanceEndEditable -->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <!-- Búsqueda Google -->
</div>
                    <div id="titulo_contenido"><a name="start" id="start"></a><!-- InstanceBeginEditable name="titulo" -->Requisitos para pr&eacute;stamo a corto plazo   <!-- InstanceEndEditable --></div>
                    <div id="texto_contenido">
                      <p><!-- InstanceBeginEditable name="cuerpo" -->
					    <p align="center" class="titulo_bold_negro">Requisito para solicitar    Pr&eacute;stamos a Corto Plazo.</p>
					    <p> <span class="txt_normal">- Que cotice 6 meses   (minimo)&nbsp; para la direcci&oacute;n de Pensiones</span>.<br />
				          <span class="txt_normal">- Que tenga fondo   disponible &oacute; en su caso que consiga  avales con disponibilidad para   prestarle.<br />
				          - El plazo m&aacute;ximo para   descontarle el pr&eacute;stamo es a 36  quincenas.<br />
			            - En caso de tener pr&eacute;stamo   anterior que haya cubierto la  mitad del adeudo.</span></p>
					    <p align="center"><a href="imagenes/img/formacorto.jpg" target="_blank" class="txt_normal"><strong>Formato   Pr&eacute;stamos a Corto Plazo</strong></a></p>
