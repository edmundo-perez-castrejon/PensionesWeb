      ...
      <div id="container">
		...
		<!--Navegacion vertical-->      
          ...
          <div id="contenido_interior_icc">
          			<div id="ruta_sitio"><a href="http://pensiones.col.gob.mx/2010/index.php"><strong>inicio</strong></a>  &nbsp;&nbsp;&nbsp; •  &nbsp; <!-- InstanceBeginEditable name="seccion" --><a href="legislacion.php">Ley de pensiones </a><!-- InstanceEndEditable -->   &nbsp;&nbsp;•    &nbsp;&nbsp;<!-- InstanceBeginEditable name="contenido" --><a href="#">Cap&iacute;tulo I </a><!-- InstanceEndEditable -->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <!-- Búsqueda Google -->
</div>
                    <div id="titulo_contenido"><a name="start" id="start"></a><!-- InstanceBeginEditable name="titulo" -->Ley de Pensiones - Cap&iacute;tulo I <!-- InstanceEndEditable --></div>
                    <div id="texto_contenido">
                      <p><!-- InstanceBeginEditable name="cuerpo" -->
					    <p class="titulo_bold_negro">CAPITULO I</p>
					    <p align="center" class="txt_normal"><strong>Generalidades</strong></p>
					    <p align="justify"> <span class="enlaces">Art. 1&ordm;.- Para los efectos que precisa esta Ley, se crea un organismo descentralizado, denominado Direcci&oacute;n de Pensiones del Estado. Esta Ley tiene aplicaci&oacute;n para los funcionarios y empleados al servicio del Estado.<br />
                              <br />
					      Art. 2&ordm;.- Pueden acogerse a los beneficios de este ordenamiento todos los funcionarios y empleados dependientes de Institutos o Patronatos y Organismos descentralizados, as&iacute; como los municipales.</span></p>
					    <p align="justify" class="enlaces"> Art. 3&ordm;.- Las personas a que se contraen los art&iacute;culos anteriores tienen derecho conforme las disposiciones de la presente Ley y en los casos y con los requisitos que ella establece, a los siguientes beneficios:<br />
                            <br />
					      I.- Pensiones de retiro.<br />
					      II.- Devoluci&oacute;n de los descuentos que se les hubieren hecho para integrar el fondo econ&oacute;mico de la Direcci&oacute;n, al separarse del servicio .<br />
					      III.- Obtenci&oacute;n de pr&eacute;stamos hipotecarios.<br />
					      IV.- Obtenci&oacute;n de pr&eacute;stamos quirografarios.<br />
					      V.- Obtener en propiedad o arrendamiento casas o terrenos, propiedad de la Direcci&oacute;n de Pensiones.<br />
				      VI.- Los dem&aacute;s que establece esta Ley.</p>
