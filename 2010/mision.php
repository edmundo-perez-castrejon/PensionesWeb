      ...
      <div id="container">
		...
		<!--Navegacion vertical-->      
          ...
          <div id="contenido_interior_icc">
          			<div id="ruta_sitio"><a href="http://pensiones.col.gob.mx/2010/index.php"><strong>inicio</strong></a>  &nbsp;&nbsp;&nbsp; •  &nbsp; <!-- InstanceBeginEditable name="seccion" --><a href="#">Misi&oacute;n y visi&oacute;n </a><!-- InstanceEndEditable -->   &nbsp;&nbsp;•    &nbsp;&nbsp;<!-- InstanceBeginEditable name="contenido" --><a href="#"></a><!-- InstanceEndEditable -->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <!-- Búsqueda Google -->
</div>
                    <div id="titulo_contenido"><a name="start" id="start"></a><!-- InstanceBeginEditable name="titulo" -->Misi&oacute;n y visi&oacute;n    <!-- InstanceEndEditable --></div>
                    <div id="texto_contenido">
                      <p><!-- InstanceBeginEditable name="cuerpo" -->
					    <p align="center" class="txt_normal"><strong>MISI&Oacute;N</strong></p>
					    <p class="txt_normal">Contribuir al fortalecimiento de  la seguridad social de los trabajadores afiliados al Fondo de Pensiones  Civiles, a trav&eacute;s de pr&eacute;stamos a corto plazo, pr&eacute;stamos hipotecarios y la  administraci&oacute;n de servicios m&eacute;dicos para el mejoramiento de su calidad de vida.</p>
					    <p align="center" class="txt_normal"><strong>VISI&Oacute;N</strong></p>
					    <p class="txt_normal">A 2010 ser una organizaci&oacute;n  eficiente, transparente y con solvencia financiera para entregar servicios de  calidad a los trabajadores afiliados al fondo de pensiones de acuerdo a la ley  vigente y aplicando la mejora continua en los procesos internos.</p>
					    <p align="center" class="titulo_bold_negro">&nbsp;</p>
